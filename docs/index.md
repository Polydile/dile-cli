...
This is the CLI from the [Dile Components catalog](https://dile-components.com/), designed to quickly build the scaffolding for components that require more configuration effort, especially those dedicated to creating [dynamic CRUDs](https://dile-components.com/crud/).
